...
\include{Chapters/02-ir}
\include{Chapters/03-simulation}
\include{Chapters/04-evaluation}
\include{Chapters/05-related}
...
\cleardoublepage\includepdf[pages={-}]{FrontBackMatter/declaration-originality.pdf}
%----------------------------------------------------------------------------------------
